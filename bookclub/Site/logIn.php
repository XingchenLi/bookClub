...
<html lang="en">
  <head>
	...
	<link rel="icon" type="image/x-icon" href="../account/css/favicon.ico" />
	
    <!-- Bootstrap core CSS -->
    <link href="../account/css/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../account/css/jumbotron-narrow.css" rel="stylesheet">
	
	<link rel="stylesheet" href="../account/css/font-awesome.min.css">
	 
    <!-- JavaScript -->
    <script src="../account/js/jquery-1.10.2.min.js"></script>
	<script src="../account/js/bootstrap.js"></script>
	<script src="../account/js/userfrosting.js"></script>
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron">
		...
		<a class="btn btn-primary" href='../account/install/wizard_site_config.php'>Start Installation</a>
	  </div>
      <div class="footer">
